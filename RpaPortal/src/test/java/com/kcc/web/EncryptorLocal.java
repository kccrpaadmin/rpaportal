...
public class EncryptorLocal {
private static final Logger logger = LoggerFactory.getLogger(EncryptorLocal.class);
	...
	public static void main(String[] args) {
        ...
        String urlDB1 = encryptor.encrypt("jdbc:sqlserver://70.71.14.111:1433;DatabaseName=RPADB;loginTimeout=90;queryTimeout=-1");
