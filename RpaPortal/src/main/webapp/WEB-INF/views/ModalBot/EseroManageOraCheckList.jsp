...
<script type="text/javascript">
    ...
    function makeGrid(pListDatas) {
        ...
        initdata.Cols = [
            ...
            { Header: "국세청|국세청인증번호", Type: "Text", Width: 180, SaveName: "invoiceIssueNo", Align: "Center" },
            { Header: "국세청|계산서일자", Type: "Text", Width: 80, SaveName: "invoiceMakeDate", Align: "Center" },            
            { Header: "국세청|공급가액", Type: "Float", Width: 100, SaveName: "invoiceSupplyAmt"  },
            { Header: "국세청|부가가치세", Type: "Float", Width: 100, SaveName: "invoiceVatAmt"  },
            { Header: "국세청|합계", Type: "Float", Width: 100, SaveName: "totAmt" },
