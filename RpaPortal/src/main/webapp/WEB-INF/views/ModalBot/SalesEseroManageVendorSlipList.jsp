...
<script type="text/javascript">
	...
	function listEseroManageVendorInvoiceList(pVendorCd, pRequestNo, pYearMon, pInvoiceTypeCd) {
		$.ajax({
			url: "/AjaxBot/ListSalesEseroManageVendorInvoiceList.do",
			type: "POST",
    ...
    function makeGrid1(pListDatas) {
        ...
        initdata.Cols = [
            ...
            { Header: "공급받는자이메일", Type: "Text", Width: 150, SaveName: "buyEmail1" },
            { Header: "공급하는자이메일", Type: "Text", Width: 150, SaveName: "salesEmail1" }
