...
<script type="text/javascript">
	...
	// 웹크롤링 실행
	function runCrawl(pMenuId, pEmpNo) {
		$.ajax({
	...
	function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		...
		if (mySheet.ColSaveName(Col) == "requestNm") {
			...
			libraryFunc.createModal(null, null, null, 1100, 595, "결과보기", "/ModalCrawl/SystemCheckRunResult.do" + "?pMenuId=" + menuId + "&pRequestNo=" + requestNo);
   		}
	}
	...
	function runCrawlConfirm(pOption) {
		if (pOption.sdBtnKey == "o") {
			runCrawl(menuId, commonFunc.certInfo.empNo);
        }
	}
	...
	$(document).on("click", "#btn_immediate_call", function (e) {
		libraryFunc.createDialog("Confirm", null, null, null, null, "알림", "요청을 진행 하시겠습니까?", null, runCrawlConfirm, null);
	});
