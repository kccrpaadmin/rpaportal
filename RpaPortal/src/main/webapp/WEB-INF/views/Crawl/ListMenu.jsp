	...
	<div class="contents">
		...
		<div class="location_box">
			<div class="location_left">
				<div class="location_title">웹크롤링</div>	
			</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
    	createCrawlMenulList($("#search_txt").val());
    });
	
	// 웹크롤링 메뉴 목록 생성 함수
	function createCrawlMenulList(pSearchTxt) {
		$.ajax({
			url: "/AjaxMenu/ListCrawlMenu.do",
			type: "POST",
			...
			success: function(listDatas) {
				commonFunc.createCrawlMenulList("craw_menu_list_box", listDatas);
			},
	...
	// 업무설명 버튼 클릭 이벤트
	$(document).on("click", ".btn_crawl_work_info", function (e) {
	...
	// 업무수행 버튼 클릭 이벤트
	$(document).on("click", ".btn_crawl_run_info", function (e) {
		var menuId = $(this).parent().parent().attr("id");
	...
	// 업무관리 버튼 클릭 이벤트
	$(document).on("click", ".btn_crawl_manage_info", function (e) {
  		var menuId = $(this).parent().parent().attr("id");
  		var userId = commonFunc.certInfo.userId;
		var titleCd = commonFunc.certInfo.titleCd;
		var deptCd = commonFunc.certInfo.deptCd;
