	...
	<div class="contents">
		...
		<div class="location_box">
			<div class="location_left">
				<div class="location_title">OCR</div>	
			</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
    	createOcrMenulList($("#search_txt").val());
    });
	
	// OCR 메뉴 목록 생성 함수
	function createOcrMenulList(pSearchTxt) {
		$.ajax({
			url: "/AjaxMenu/ListOcrMenu.do",
			type: "POST",
			...
			success: function(listDatas) {
				commonFunc.createOcrMenulList("ocr_menu_list_box", listDatas);
			},
	...
	// 업무설명 버튼 클릭 이벤트
	$(document).on("click", ".btn_ocr_work_info", function (e) {
  		var menuId = $(this).parent().parent().attr("id");
  		libraryFunc.createModal(null, null, null, 500, 250, "업무설명", "/ModalOcr/WorkInfo.do?pMenuId=" + menuId + "&pEmpNo=" + commonFunc.certInfo.empNo);
	});
	
	// 업무수행 버튼 클릭 이벤트
	$(document).on("click", ".btn_ocr_run_info", function (e) {
		var menuId = $(this).parent().parent().attr("id");
