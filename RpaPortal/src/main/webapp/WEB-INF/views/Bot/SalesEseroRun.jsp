...
<div id="container">
	...
	<div class="contents">
	    ...
	    <!-- 버튼영역 -->
	    <div class="btn_box">
	    	<a class="btn_common1" id="btn_target_date_open">대상기간</a>
...
<script type="text/javascript">
	...
	function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		...
		if (mySheet.ColSaveName(Col) == "requestNm") {
			...
			libraryFunc.createModal(null, null, null, 1100, 560, "결과보기", "/ModalBot/SalesEseroRunResult.do" + "?pMenuId=" + menuId + "&pRequestNo=" + requestNo);
   		}
	}
	...
	$(document).on("click", "#btn_target_date_open", function (e) {
		libraryFunc.createModal(null, null, null, 500, 340, "대상기간", "/ModalBot/SalesEseroTargetDate.do?pMenuId=" + menuId);
	});
