...
<div id="container">
	...
	<div class="contents">
	    ...
	    <!-- 버튼영역 -->
	    <div class="btn_box">
	    	<a class="btn_common1" id="btn_target_person" >대상공사</a>
...
<script type="text/javascript">
	...
	function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		...
		if (mySheet.ColSaveName(Col) == "requestNm") {
			...
			libraryFunc.createModal(null, null, null, 1100, 560, "결과보기", "/ModalBot/BidChangeRunResult.do" + "?pMenuId=" + menuId + "&pRequestNo=" + requestNo);
   		}
	}
	...
	$(document).on("click", "#btn_target_person", function (e) {
		libraryFunc.createModal(null, null, null, 1100, 660, "대상공사", "/ModalBot/BidChangeRunTargetBid.do?pMenuId=" + menuId);
	});
