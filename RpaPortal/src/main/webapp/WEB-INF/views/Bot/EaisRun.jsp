...
<div id="container">
	...
	<div class="contents">
	    ...
	    <!-- 버튼영역 -->
	    <div class="btn_box">
	    	<a class="btn_common1" id="btn_schedule" >스케줄등록</a>
...
<script type="text/javascript">
	...
	function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		...
		if (mySheet.ColSaveName(Col) == "requestNm") {
			...
			libraryFunc.createModal(null, null, null, 1000, 460, "결과보기", "/ModalBot/EaisRunResult.do" + "?pMenuId=" + menuId + "&pRequestNo=" + requestNo);
   		}
	}
	...
	// 스케줄등록 버튼 클릭 이벤트
	$(document).on("click", "#btn_schedule", function (e) {
		libraryFunc.createModal(null, null, null, 800, 360, "스케줄등록", "/ModalBot/EaisSchedule.do?pMenuId=" + menuId);
	});
</script>