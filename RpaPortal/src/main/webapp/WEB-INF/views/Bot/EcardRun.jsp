...
<div id="container">
	...
	<div class="contents">
	    ...
	    <div class="btn_box">
	    	...
	    	<a class="btn_common1" id="btn_immediate_call2" style="display:none;">즉시실행(관리자용)</a>	
...
<script type="text/javascript">
	...
	$(document).ready(function (e) {
		...
		btninit(commonFunc.certInfo.roleType)
	});
	
	function btninit(roleType) {
		if(roleType == "ROLE_ADMIN")
		{
			$("#btn_immediate_call2").css("display", "inline-block");
 ...
 // 그리드 클릭 함수
	function mySheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		...
		if (mySheet.ColSaveName(Col) == "requestNm") {
			...
			libraryFunc.createModal(null, null, null, 1100, 560, "결과보기", "/ModalBot/EcardRunResult.do" + "?pMenuId=" + menuId + "&pRequestNo=" + requestNo);
   		}
	}
	...
	$(document).on("click", "#btn_immediate_call", function (e) {
		if (commonFunc.getCheckNullYn($("#site_cd").val()) == "Y") {
			libraryFunc.createDialog("Alert", null, null, null, null, "알림", "대상현장을 선택하지 않았습니다.", null, null, null);
			return false;
		}
	...
	// 즉시실행 버튼 클릭 이벤트
	$(document).on("click", "#btn_immediate_call2", function (e) {
		libraryFunc.createDialog("Confirm", null, null, null, null, "알림", "전체 현장에 대한 요청을 진행 하시겠습니까?", null, runBotConfirm2, null);
	});
