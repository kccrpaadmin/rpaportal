...
<script type="text/javascript">
	...
	$(document).ready(function (e) {
		listSystemCheckList(requestNo);
	});
	
	// 시스템체크 수집 파일경로 목록 조회
	function listSystemCheckList(pRequestNo) {
		$.ajax({
			url: "/AjaxCrawl/ListSystemCheckList.do",
			type: "POST",
			...
			success: function(listDatas) {
				makeGrid(listDatas);
				commonFunc.createSystemCheckCaptureList("capture_list_box", listDatas.data);
			},
