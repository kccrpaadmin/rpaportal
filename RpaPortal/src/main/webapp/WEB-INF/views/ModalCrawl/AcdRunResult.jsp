...
<script type="text/javascript">
	...
	//  사고사례 수집 데이터 목록 조회
	function listAcd(pRequestNo) {
		$.ajax({
			url: "/AjaxCrawl/ListAcd.do",
			type: "POST",
    ...
    function makeGrid(pListDatas) {
        ...
        initdata.Cols = [
            ...
            { Header: "번호", Type: "Int", Width: 80, SaveName: "seq", Align: "Center" },
            { Header: "사고발생일자", Type: "Text", Width: 100, SaveName: "accidentDate", Align: "Left" },
            { Header: "사고개요", Type: "Text", Width: 380, SaveName: "subject" , Align: "Left" },
            { Header: "재해형태", Type: "Text", Width: 120, SaveName: "accidentType" , Align: "Left"},
            { Header: "출처", Type: "Text", Width: 180, SaveName: "source", Align: "Center" },
            { Header: "바로가기", Type: "Text", Width: 200, SaveName: "link" , Align: "Left"}
        ];
