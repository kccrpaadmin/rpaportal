		...
		if (!"Local1".equals(commonUtilService.getServerEnv()) && !"Local2".equals(commonUtilService.getServerEnv())) {
			...
			try {
				...
				for (BotScheduleVO botScheduleVO : outListBotScheduleVO) {
					...
					if("RA004007".equals(botScheduleVO.getMenuId().toString()) || "RA004022".equals(botScheduleVO.getMenuId().toString()) || "RA004025".equals(botScheduleVO.getMenuId().toString()) || "RA004029".equals(botScheduleVO.getMenuId().toString()) || "RA004030".equals(botScheduleVO.getMenuId().toString()) || "RA004032".equals(botScheduleVO.getMenuId().toString())  )
					{
