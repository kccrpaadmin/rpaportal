...
public class ModalBotController extends BaseController {
	...
	@GetMapping("/BidChangeRunResult.do")
	public String BidChangeRunResult(String pMenuId, String pRequestNo, Model model) {
		logger.info("/ModalBot/BidChangeRunResult.do");
	...
	@GetMapping("/ChgPersonalBccRunResult.do")
	public String ChgPersonalBccRunResult(String pMenuId, String pRequestNo, Model model) {
		logger.info("/ModalBot/ChgPersonalBccRunResult.do");
	...
	@GetMapping("/StampTaxSlipDataRunResult.do")
	public String StampTaxSlipDataRunResult(String pMenuId, String pRequestNo, Model model) {
		logger.info("/ModalBot/StampTaxSlipDataRunResult.do");
