...
import com.ibleaders.ibsheet.excel.ExcelPrintSetup;
import com.ibleaders.ibsheet.util.Version;
...
public class IbsheetController {
	...
	public String Down2Excel(HttpServletRequest request, HttpServletResponse response) {
