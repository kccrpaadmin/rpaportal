...
public class ConstWord {
	...
	public final static String CRAWL_LOCAL1_IP = "http://70.71.14.113:80/AppCrawl/RunWebCrawl";
	public final static String CRAWL_LOCAL2_IP = "http://70.71.14.116:80/AppCrawl/RunWebCrawl";
	public final static String CRAWL_DEV_IP = "http://70.71.14.120:80/AppCrawl/RunWebCrawl";
	public final static String CRAWL_REAL_IP = "http://70.71.14.124:80/AppCrawl/RunWebCrawl";
	...
	public final static String FILE_MAXSIZE_ERROR = "최대 첨부 용량을 초과 하였습니다.";
}