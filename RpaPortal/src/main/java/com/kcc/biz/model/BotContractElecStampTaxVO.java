...
public class BotContractElecStampTaxVO {
	...
	public String getKCCStampTaxAmt() {
		return KCCStampTaxAmt;
	}
	public void setKCCStampTaxAmt(String kCCStampTaxAmt) {
		KCCStampTaxAmt = kCCStampTaxAmt;
	}
